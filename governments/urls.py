...
urlpatterns = [
    ...
    path('governments/add_schedule/<int:government_id>/', views.add_schedule, name='add_schedule'),
    path('governments/government_details/<int:government_id>/', views.government_details, name='government_details'),
